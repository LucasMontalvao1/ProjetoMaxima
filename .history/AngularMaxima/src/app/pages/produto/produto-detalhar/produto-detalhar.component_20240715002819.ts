...
export class ProdutoDetalharComponent implements OnInit {
  ...
  // Métodos para edição e exclusão do produto
  editarProduto(): void {
    // Implemente a lógica para navegar para a página de edição com o ID do produto
  }

  excluirProduto(): void {
    // Implemente a lógica para navegar para a página de exclusão com o ID do produto
  }
