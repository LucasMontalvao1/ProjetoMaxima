...
export class ProdutoComponent {
  ...
  // Exemplo de uso da função criarProduto
  criarNovoProduto() {
    ...
    // Chamar a função criarProduto com os argumentos corretos
    this.produtoService.criarProduto(codigo, descricao, preco, departamentoCodigo, status, inutilizavel)
      .subscribe(
        (response) => {
